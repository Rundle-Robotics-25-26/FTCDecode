...
@Configurable
@TeleOp(name = "SmallBlueTele")
public class BlueTeleSmall extends OpMode {
    private Follower follower;
    public static Pose startingPose = new Pose(48, 9, Math.toRadians(90)); // Default starting pose
    ...
    public void init() {
        ...
        pathChain = () -> follower.pathBuilder() //Lazy Curve Generation
                .addPath(new Path(new BezierLine(follower::getPose, new Pose(105, 33))))
    ...
    public void loop() {
        ...
        // *** Command ONLY Target B ***
        shooterFunctions.setShooterPowerTargetB(shooterCommanded);

        // Optional: Explicitly disable Target A for safety
        shooterFunctions.setShooterPowerTargetA(false);
        //intake
